...
| ---------- | ------ | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `0x67`     | `0x03` | 99        | Per-minute rinse telemetry sampler — partial decode 2026-06-12: `inner[24]` = elapsed minutes since RINSE start (matched wall-clock across ten in-cycle frames); `inner[21]` a counter; `inner[31..47]` a sample-array region (zeroed in most frames, populated in bursts — unidentified sensor data). **No field tracks remaining time** — the remainTimeMinute hypothesis is dead. |
