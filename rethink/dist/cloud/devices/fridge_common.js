export function fridgeRange(temperatureUnit) {
...
export function freezerRange(temperatureUnit) {
    if (temperatureUnit === 'F') {
        return {
            unit_of_measurement: '°F',
            min: -7,
...
export function convertFridgeTemperature(temperatureUnit, input) {
    if (temperatureUnit === 'F')
        return 44 - input;
    else
        return 8 - input;
}
export function convertFreezerTemperature(temperatureUnit, input) {
    if (temperatureUnit === 'F')
        return 6 - input;
    else
        return -14 - input;
...
export function unpackStatus(buf) {
    let rv = {};
...
export function packStatus(status, length) {
