...
export async function signedRequest(url, headers = {}, body = undefined) {
...
export async function fromCode(authUrl, code) {
    ...
    const response = await signedRequest(authUrl + '/oauth/1.0/oauth2/token', {
...
export async function refresh(authUrl, refreshToken) {
    const params = new URLSearchParams();
